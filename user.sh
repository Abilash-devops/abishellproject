...
cp -rp /home/centos/abishellproject/user.service /etc/systemd/system/user.service &>> $LOGFILE
...
cp -rp /home/centos/abishellproject/mongo.repo /etc/yum.repos.d/mongo.repo &>> $
